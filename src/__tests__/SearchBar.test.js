...
describe('SearchBar component', () => {
  test('renders properly', () => {
    ...
    const { getByPlaceholderText } = render(<SearchBar searchKeywords={searchKeywords}/>);
  ...
  test('handles search input correctly', () => {
    const searchKeywords= jest.fn();
    const { getByPlaceholderText, getByRole } = render(<SearchBar searchKeywords={searchKeywords} />);
    const inputElement = getByPlaceholderText('Search for Recipe');
